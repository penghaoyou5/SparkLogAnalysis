...
public class IPSeekerUtil {
    ...
    public static String[] chinaToEnglish(HashMap<String,String> contrastMap,String chinaStr){
        if (contrastMap.containsKey(chinaStr)){
            return  new String[]{chinaStr,contrastMap.get(chinaStr)};
        }else {
            Iterator<Map.Entry<String,String>> iter = contrastMap.entrySet().iterator();
            while (iter.hasNext()) {
                Map.Entry<String,String> entry = iter.next();
                String key = entry.getKey();
                String val = entry.getValue();
                if(chinaStr.contains(key) | chinaStr.contains(val)){
                    return new String[]{key,val};
                }

            }
            return new String[]{"未知","UNKNOW"};
        }
    }

    public static HashMap<String,String> PROVINCE_EN = new HashMap<String, String>(){
        {

            put("北京","BJ"); put("上海","SH"); put("天津","TJ"); put("重庆","CQ");
            put("香港","HK"); put("澳门","MA"); put("台湾","TA"); put("黑龙江","HLJ"); put("吉林","JL");
            put("辽宁","LN"); put("河北","HEB"); put("内蒙古","NMG"); put("山西","SX"); put("山东","SD"); put("陕西","SXS"); put("宁夏","NX"); put("甘肃","GS");
            put("青海","QH"); put("新疆","XJ"); put("西藏","XZ"); put("四川","SC"); put("河南","HEN"); put("湖北","HUB"); put("安徽","AH"); put("江苏","JS");put("云南","YN");
            put("贵州","GUZ"); put("湖南","HUN"); put("江西","JX"); put("浙江","ZJ"); put("福建","FJ"); put("广西","GX"); put("广东","GD"); put("海南","HAN");
            put("其它","OTHER"); put("未知","UNKNOW");
        }
    };
    public static HashMap<String,String> ISP_EN = new HashMap<String, String>(){
        {
            put("电信","CHN"); put("联通","CNC"); put("移动","CMN"); put("教育网","CER"); put("铁通","CRN"); put("科技网","CST"); put("互连通","CNL");
            put("电信通","DXT"); put("北京歌华","BGC"); put("长城宽带","GWB"); put("世纪互联","VNC"); put("中电飞华","FIB"); put("中华电信","CHT");
            put("中电华通","CHC"); put("中信网络","CIC"); put("中国金桥信息网","GBN"); put("首信","CPI"); put("ChinaCache多通机房","CCN"); put("NAP","NAP");
            put("上海广电","SCN"); put("虚拟运营商","DUM"); put("上海热线","SOL"); put("台湾台北是方电讯","CFT"); put("贝尔网络","BEL"); put("PBL","PBL");
            put("美国","USA"); put("日本电信电话","NTT"); put("新一代网络","XYD"); put("PACNET","PAC"); put("SHANGHAIOL","SOL"); put("CHIEFTELECOM","CFT");
            put("FBN","FBN"); put("全华","CNT"); put("蓝波宽带","BWB"); put("Hostway","HOW"); put("卡塔尔电信","QTE"); put("边界网关协议","BGP"); put("广电网络","CBN");
            put("印尼电信","PTI"); put("台湾移动","TWM"); put("其它","OTHER"); put("未知","UNKNOW");
        }
    };

    private static LruCache<String,String[]> IP_WLK_ADDRESS= new LruCache<>(30000);



    public static String[] getWlkAddressByIp(String ip){
        String[] arrResult =IP_WLK_ADDRESS.get(ip);
        if(arrResult!=null){
            return arrResult;
        }
        if(ipSeeker == null){
